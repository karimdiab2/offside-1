...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المخازن</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تسجيل مخزن جديد</span>
						</div>
					</div>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">جدول عرض فقط لجميع المخازن ..... في حالة التعديل علي بيانات اي مخزن برجاء الذهاب إلي صفحة المخازن </p>
							</div>
							<div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        // Allow only numeric input for warehouse_address
        $('input[name="warehouse_address"]').on('input', function() {
